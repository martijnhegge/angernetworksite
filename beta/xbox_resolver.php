<?php
    ...
    include "../../xbox_resolver/inc/psn.php";
    include "../../xbox_resolver/inc/database.php";
    $con = new database;
    $user = new user;
    $con->connect();
    $user->initChecks();
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-body">
                            ...
                            <h6 class="card-subtitle"></h6>
                                ...
                                <div class="form-group">
                                <button type="button"onclick="xbox_gamertag(document.getElementById('gamertag').value)" class="btn btn-primary btn-block">Lookup an Gamertag to see details.</button>
                                </div>
                            </form>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                            ...
                            <h6 class="card-subtitle"></h6>
                                ...
                                <div class="form-group">
                                <button type="button"onclick="xbox_ip(document.getElementById('ip').value)" class="btn btn-primary btn-block">Lookup an IP to see details.</button>
                                </div>
                            </form>    
                            </div>
                        </div>
...
<script>
        ...
        var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET","https://insane-dev.xyz/xbox_resolver/inc/function/xbox.php?resolve_this=Statics", true);
            xmlhttp.send();}
        function xbox_gamertag(query_responsetime) {
        $("#return_result").html('');    
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
...
xmlhttp.open("POST", "https://insane-dev.xyz/xbox_resolver/inc/function/xbox.php?resolve_this=xbox_gamertag", true);
...
<script>
        ...
        var xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET","https://insane-dev.xyz/xbox_resolver/inc/function/xbox.php?resolve_this=Statics", true);
            xmlhttp.send();}
        function xbox_ip(query_responsetime) {
        $("#return_result").html('');    
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
...
xmlhttp.open("POST", "https://insane-dev.xyz/xbox_resolver/inc/function/xbox.php?resolve_this=xbox_ip", true);
xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
