              ...
              <div class="login__body">
                    ...
                    if($res['2'] != "1"){
                        ...
                        <form method="POST" action="">
                            ...
                            <input type="text" class="form-control text-center" required id="verifyid" name="verifyid" value="'.$verifyid.'" hidden>
                        </div><br>
                    <a onclick= "verify(this)" class="btn btn-theme btn-block" hidden>verify me!</a>
                     </form>';
                    }?></div>
