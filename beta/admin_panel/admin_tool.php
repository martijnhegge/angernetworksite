                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive data-table">
                            <table id="data-table" class="table table-sm">
                                ...
                                <tbody>
                                <?php 
                                $query = $con->db->prepare("SELECT * FROM `tool_logs` WHERE `user_id` = :license ORDER BY `time` DESC");
                                $query->execute(array("license"=>$user->getFromTable_ThisId("id", "users", $_GET['id'])));
                                $res = $query->fetchAll();
                                foreach($res as $row){
                                echo '
                                    <tr>
