        ...
        <header class="header">
            ...
            <section class="content">
                <header class="content__title">
                    <h1>removed booter logs<small></small></h1>
                </header>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive data-table">
                            <table id="data-table" class="table table-sm">
                                ...
                                <tbody>
                                <?php 
                                            $query = $con->db->prepare("SELECT nobooter_access.*,users.username FROM `nobooter_access` JOIN `users` on users.id = nobooter_access.userid");
                                            $query->execute();
                                            $res = $query->fetchAll();
                                            foreach($res as $row){
                                                echo '
