                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive data-table">
                            <table id="data-table" class="table table-sm">
                                ...
                                <tbody>
                                <?php 
                                            $query = $con->db->prepare("SELECT ddos_attack_log.*,users.username FROM `ddos_attack_log` JOIN `users` on users.id = ddos_attack_log.userid");
                                            $query->execute();
                                            $res = $query->fetchAll();
                                            foreach($res as $row){
                                                echo '
