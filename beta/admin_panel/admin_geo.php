        ...
        <header class="header">
            ...
            <section class="content">
                <header class="content__title">
                    <h1>Admin Geo Lookup<small></small></h1>
                </header>
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Admin Geo Locate</h4>
                        <h6 class="card-subtitle"></h6>
                        <div class="form-group">
                        <form method="POST">
                        <input class="form-control text-center" name="search_ip" id="search_ip" placeholder="<?php if(!empty($check_ip->ip)){ echo $check_ip->ip; }else{ echo "IP Address"; } ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                            <a type="submit" href="admin_resolver.php"class="btn btn-primary btn-block">Return To Admin Resolve</a>
                            </div>
              ...
              <td><?php if(!empty($check_ip->country_name))
               { echo $check_ip->country_name; }
                else { echo ""; } ?><!--<span class='flag-icon flag-icon-fr'></span><img src="https://json.geoiplookup.io/{$ip}>" width="30" height="20" border="0">-->
              </tr>
              <tr>
              <td>Continent </td>
