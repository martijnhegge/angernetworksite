        ...
        <header class="header">
            ...
            <section class="content">
                <header class="content__title">
                    <h1>Resolver Logs<small></small></h1>
                </header>
                        ...
                        <div class="table-responsive data-table">
                            <table id="data-table" class="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <th>The Date Added</th>
                                    <th>User Who's Resolve</th>
                                    <th>User Manage</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php 
                                            $query = $con->db->prepare("SELECT * FROM `RESOLVES`");
                                                ...
                                                echo '
                                                    <tr>    
                                                        ...
                                                        ';
                                                         echo '
                                                        <td>
                                                            <a class="btn btn-theme btn-sm " href="admin_geo.php?id='.$row['id'].'">Manage</a>
                                                            <a type="submit" value="Submit" class="btn btn-danger btn-sm " name="delete1" href="admin_resolver.php?id='.$row['id'].'">Delete</a>    
                                                        </td>
                                                    </tr>
                                                ';
                                            }
