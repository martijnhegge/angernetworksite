...
//include "user.php";
//$user = new user;
class translation //extends user
{
//$user = new user;
/*public function __construct(){
			
		}*/
	public function lng($txt) {
		global $lang;
		//$lang = $this->getFromTable_MyId('Language', 'users');
	    // English Language
	    ...
	    $tr['en']['TFA'] = 'Tool Features/Announcement';
	    
	    // $i18n = fm_get_translations($tr);
	    // $tr = $i18n ? $i18n : $tr;

	    if (!strlen($lang)) $lang = 'en';
	    /* if (isset($tr[$lang][$txt])) return*/ return ($tr[$lang][$txt]);
