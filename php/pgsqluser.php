...
//include "errorhandler.php";
		...
		public function getWhoIsOnline(){
			...
			foreach($rowCount as $row){	
				...
				/*}
				else  <img class="user__img" src="'.$row['pic'].'" style="width: 20px; height: 20px;"/>
				{       
					    echo '   
   ...
   //  		}
		...
		if(strtotime($result['expiry_date']) > time())
		{
			echo '
			    <li>
                    <a href="index"><i class="zwicon-home "></i>Dashboard</a>
                </li>
            ';
        	...
        	{ 
        		echo '
	                <li>
	                    <a href="attackhub"><i class="zwicon-deploy text-white"></i>AnGerStressr - Hub</a>
	                </li>
                ';
            }
        	echo '
                <!--<li>
                    <a href="codes"><i class="zwicon-deploy text-white"></i>RTM Basic Codes</a>
                </li>-->
                <li>
                    <a href="profile"><i class="zwicon-user-follow text-white"></i>Profile</a>
                </li> 
                <li>
                    <a href="user_app"><i class="zwicon-download text-white"></i>Downloads</a>
                </li> 
                <li>
                    <a href="blacklist"><i class="zwicon-eye-slash text-white"></i>Blacklist</a>
                </li>
                <!--<li>
                    <a href="logger"><i class="zwicon-database text-white"></i>PSN+IP Logger</a>
                </li>-->
                    <li class="navigation__sub">
                        <a  href="" data-mae-action="submenu-toggle"><i class="zwicon-plus text-white"></i>Misc & Tools</i></a>
                        <ul>
                            <li>
                                <a  href="geo">Geo Lookup</a>
                            </li>
                            <li>
                                <a  href="skype">Skype Resolver</a>
                            </li>
                            <li>
                                <a  href="psn_resolver">PSN Resolver</a>
                            </li>
                              <li>
                                <a  href="xbox_resolver">XBOX Resolver</a>
                            </li>
                            <li>
                                <a  href="psn_history">PS3 History</a>
                            </li>
                            <li>
                                <a  href="xbox_history">XBOX History</a>
                            </li>
                            <li>
			                    <a href="logger"><!--<i class="zwicon-database text-white"></i> -->PSN+IP Logger</a>
			                </li>
			                <li>
			                    <a href="logger">Database Leaks</a>
			                </li>
                            <li>
                                <a  href="whois">Whios / Domain Lookup</a>
                            </li>
                            <li>
                                <a  href="storage">IP Storage</a>
                            </li>
                            <li>
                                <a  href="ping">IP Pinger</a>
                            </li>
                            <li>
                                <a  href="port">Port Scanner</a>
                            </li>
                             <li>
                                <a  href="iplogger">IP Logger</a>
                            </li>
                        </ul>
                    <li>    
                <li>
                    <a href="support"><i class="zwicon-info-circle text-white"></i>Support</a>
                </li>
                <li>
                    <a href="faq"><i class="zwicon-info-circle text-white"></i>F.a.q</a>
                </li>
                <!-- <li>
                    <a href="settings"><i class="zwicon-cog text-white"></i>Settings</a>
                </li> -->
            '; 
            if($this->isAdmin())
            {
		        echo '
		            <br>
                    <li>
	                    <a href="/admin_panel/admin_dash"><i class="zwicon-diamond "></i>Admin Dash</a>
	                </li>
	                <li>
	                    <a href="/admin_panel/admin_blacklist"><i class="zwicon-eye-slash text-white"></i>blacklist Logs</a>
	                </li>
	                <li class="navigation__sub">
                        <a  href="" data-mae-action="submenu-toggle"><i class="zwicon-plus  text-white"></i>Admin Settings</i></a>
                        <ul>
                            <li>
                                <a  href="/admin_panel/admin_settings">Website Settings</a>
                            </li>
                            <li>
                                <a  href="/admin_panel/tool_settings">Tool Settings</a>
                            </li>
                        </ul>
                    <li>            
	                <li>
	                    <a href="/admin_panel/all_users"><i class="zwicon-users text-white"></i>All Users Overview</a>
	                </li> 
	                <li>
	                    <a href="chat"><i class="zwicon-chat text-white"></i>Chat</a>
	                </li>
	            ';
	        }
	    }
	    ...
	    {   
	    	echo'
                ...
                <li>
                    <a href="apps"><i class="zwicon-dollar-sign text-white"></i>Purchase</a>
                </li> 
                <li>
                    <a href="profile"><i class="zwicon-user-follow text-white"></i>Profile</a>
                </li>
        ...
        if($this->isAdmin())
        {
		    echo '
                ...
                <li>
                    <a href="/admin_panel/admin_resolver"><i class="zwicon-window text-white"></i>Resolved Logs</a>
                </li>           
                <li>
                    <a href="/admin_panel/all_users"><i class="zwicon-users text-white"></i>All Users Overview</a>
                </li> 
		...
		public function AdminNavigation(){
		    ...
		    echo ' 
		        <li>
                    <a href="../index"><i class="zwicon-home "></i>Main Dashboard</a>
                </li>
                <li>
                    <a href="admin_dash"><i class="zwicon-diamond text-white"></i>Admin Dash</a>
                </li> 
                <li class="navigation__sub">
                        <a  href="" data-mae-action="submenu-toggle"><i class="zwicon-plus text-white"></i>Admin Logs</i></a>
                        <ul>
                            <li>
                                <a  href="logs_noadmin">No Admin Logs</a>
                            </li>
                            <li>
                                <a  href="logs_notallowed">Not Allowed Logs</a>
                            </li>
                            <li>
                                <a  href="logs_rbooter">Removed Booter Logs</a>
                            </li>
                            <li>
                                <a  href="logs_booter">Booter Logs</a>
                            </li>
                              <li>
                                <a  href="logs_login">Sign In Logs</a>
                            </li>
                            <li>
                                <a  href="logs_register">Register Logs</a>
                            </li>
                            <li>
                                <a  href="logs_toolerror">Tool Error Logs</a>
                            </li>
                            <li>
                                <a  href="logs_angerbot">AnGerBot Logs</a>
                            </li>
                            <li>
                                <a  href="logs_staff">Staff Members Logs</a>
                            </li>
                            <li>
                                <a  href="logs_skype">Skype Resolver Logs</a>
                            </li>
                            <li>
                                <a  href="logs_psnresolver">PSN Resolver Logs</a>
                            </li>
                            <!--<li>
                                <a  href="ping">IP Pinger</a>
                            </li>
                    ...
                    <li> 
                <li>
                    <a href="admin_apps"><i class="zwicon-download text-white"></i>Admin Downloads</a>
                </li>
                <li>
                    <a href="admin_clogs"><i class="zwicon-archive text-white"></i>Admin Changelogs</a>
                </li> 
                <li>
                    <a href="admin_plans"><i class="zwicon-store text-white"></i>Admin Plans</a>
                </li> 
                <li>
                    <a href="admin_news"><i class="zwicon-broadcast text-white"></i>Admin News</a>
                </li> 
                <li>
                    <a href="admin_payed"><i class="zwicon-coin text-white"></i>Admin Payments</a>
                </li>
                <li>
                    <a href="admin_userinbox"><i class="zwicon-send text-white"></i>Admin Users Inbox</a>
                </li>
                <li>
                    <a href="admin_blacklist"><i class="zwicon-eye-slash text-white"></i>blacklist Logs</a>
                </li>
                <li>
                    <a href="all_users"><i class="zwicon-users text-white"></i>All Users Overview</a>
                </li>
                <li>
                    <a href="all_tickets"><i class="zwicon-note text-white"></i>Tickets</a>
                </li>
                <li>
                    <a href="admin_settings"><i class="zwicon-cog text-white"></i>Web Settings</a>
                </li> 
                <li>
                    <a href="tool_settings"><i class="zwicon-cog text-white"></i>Tool Settings</a>
                </li> 
                <li>
                    <a href="admin_resolver"><i class="zwicon-window text-white"></i>Resolver Logs</a>
                </li> 
                <li>
                    <a> <!--href="users_logins"--><i class="zwicon-bookmark text-white"></i>coming soon</a>
                </li>  
		        ';
			}
		}
		...
		public function getPulledIPSCountPSNInsane(){
    		$rowCount = file_get_contents("https://insane-dev.xyz/api/?type=count");
			...
			foreach($res as $row){
				...
				if($this->getFromTable("level", "users", "id", $_SESSION['id']) == "1"){
					switch($this->getFromTable("level", "users", "id", $row['userid'])){
						case "Administrator":
							echo '<img class="img pull-left" width="48" height="48"  src="'.$profile_pic.'" alt="">
									<span class="pull-right">'. $row['message'] .'</span>
										<div><span class="pull-right" style="'.$this->getAdminSparkle($row['userid']).' color: '.$this->getShoutColor($row['userid']).'"><i class="fa fa-'.$this->GetTheFuckingIconsKEK($row['userid']).'"></i> '.$username.' <span class="label label-'.$OnlineStatusColor.'">'.$OnlineStatus.'</span></div>
						...
						case "Moderator":
							...
							';break;
						case "User":
							echo '<img class="img pull-right" width="48" height="48"  src="'.$profile_pic.'" alt="">
						...
						default: 
							echo '
									<img class="img pull-right" width="48" height="48"  src="'.$profile_pic.'" alt="">
                                    <div class="block block-rounded block-transparent push-15 push-50-l">
				...
				if($this->getFromTable("level", "users", "id", $_SESSION['id']) == "1"){
					switch($this->getFromTable("level", "users", "id", $row['userid'])){
						case "Administrator":
							echo '<img class="img pull-left" width="48" height="48"  src="'.$profile_pic.'" alt="">
									<span class="pull-right">'. $row['message'] .'</span>
										<div class="block-content block-content-full block-content-mini bg-white"><span class="pull-right" style="'.$this->getAdminSparkle($row['userid']).' color: '.$this->getShoutColor($row['userid']).'"><i class="fa fa-'.$this->GetTheFuckingIconsKEK($row['userid']).'"></i> '.$username.' <span class="label label-'.$OnlineStatusColor.'">'.$OnlineStatus.'</span></div>
						...
						case "Administrator":
							echo '
								<div class="chat-message right">
                                        <img class="img pull-left" width="48" height="48" src="'.$profile_pic.'" alt="" >
                                        <div class="message ">
