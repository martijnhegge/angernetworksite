                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card stats">
                            <div class="card-body">
                                <h4 class="card-title">Online User Count</h4>
                                <h6 class="card-subtitle"><?php echo $user->getUserCountOnline(); ?></h6>                              
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card stats">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"><?php echo $user->getUserCountPaid(); ?></h6>                              
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card stats">
                            <div class="card-body">
                                <h4 class="card-title">Profit Made</h4>
                                <h6 class="card-subtitle"><?php echo $user->getProfit(); ?></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card stats">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"><?php echo $user->getTotalTickets(); ?></h6>                 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card stats">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"><?php echo $user->getTicketsOpen(); ?></h6>          
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card stats">
                            <div class="card-body">
                                <h4 class="card-title">Tickets Resolved</h4>
                                <h6 class="card-subtitle"><?php echo $user->getTicketsResolved(); ?></h6>                 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card stats">
                            <div class="card-body">
                                <h4 class="card-title">Open Tickets</h4>
                                <h6 class="card-subtitle"><?php echo $user->getTicketsClosed(); ?></h6>          
                            </div>
                        </div>
                    </div>
            </div>
