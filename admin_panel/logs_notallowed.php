        ...
        <header class="header">
            ...
            <section class="content">
                <header class="content__title">
                    <h1>not-allowed logs<small></small></h1>
                </header>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive data-table">
                            <table id="data-table" class="table table-sm">
                                ...
                                <tbody>
                                <?php 
                                            $query = $con->db->prepare("SELECT notallowed_logs.*,users.username FROM `notallowed_logs` JOIN `users` on users.id = notallowed_logs.userid");
                                            $query->execute();
                                            $res = $query->fetchAll();
                                            foreach($res as $row){
                                                echo '
